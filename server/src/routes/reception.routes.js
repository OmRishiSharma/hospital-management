...
router.get('/appointments', verifyToken, verifyReception, async (req, res) => {
    try {
        ...
        // Default: specific date or today's active/completed/cancelled appointments (full dashboard view)
        // Pass ?all=true to get full history across all dates
        // Pass ?future=true to get all future appointments beyond tomorrow
        // Pass ?tomorrow=true to get all tomorrow appointments
